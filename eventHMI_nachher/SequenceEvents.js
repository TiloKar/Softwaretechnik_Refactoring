        ...
        switch (element.ID) {
          case 50:
            push= '<b>Seq.' + String(element.data.par1 + 1) +
                  '</b> started manually <br><span class="reportListSeqTag">' + SequenceEvents.dump.seqFiles[element.data.par1].tag  +
                  "</span>";
          break;
          case 51:
            push= '<b>Seq.' + String(element.data.par1 + 1) +
          ...
          case 57:
            push= '<b>Seq.' + String(element.data.par1 + 1) +
                  '</b> stopped finally <br><span class="reportListSeqTag">' + SequenceEvents.dump.seqFiles[element.data.par1].tag  +
                  "</span>";
          break;
          ...
          case 61:
            push= '<span class="reportListFirstCol"><b>Seq.' + String(element.data.par1 + 1) +
                  ...
                  "</span></span> to" +
                  '<span class="reportListValue">' + round(element.data.new1,Trendfile.getDigitsFromUnitStr(element.data.string1)) +
